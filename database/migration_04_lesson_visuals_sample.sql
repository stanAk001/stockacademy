-- ============================================
-- StockAcademia — Visual lesson upgrade (sample)
...
3. **Practice in the simulator.** Open a chart in the StockAcademia simulator, identify candle patterns yourself, then watch what happens next. That feedback loop is how this skill is actually built.
