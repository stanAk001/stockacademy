      ...
      <Layout>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="card-soft p-8 sm:p-12 text-center">
            ...
            <h1 className="font-display text-3xl sm:text-5xl font-black leading-[1.05] mb-3">
              Stop watching the market. <span className="italic text-coral-500">Let it watch itself.</span>
            </h1>
            <p className="text-ink/65 max-w-md mx-auto mb-6 leading-relaxed">
              Set your target price once. The second a stock hits it, you're pinged — in your
              notifications <strong className="text-ink">and straight to your phone on Telegram</strong>.
              No refreshing, no FOMO, no missed entries.
            </p>
            <Link to="/upgrade" className="btn-primary">
              <Sparkles size={16} /> Unlock Price Alerts
            </Link>
            <p className="text-xs text-ink/45 mt-3">From ₦3,500/mo · cancel anytime</p>
          </div>
        </div>
      </Layout>
    );
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-8">
          <div>
            ...
            <p className="text-ink/60 mt-1">Set it and forget it — we'll ping you the moment your target hits.</p>
          </div>
