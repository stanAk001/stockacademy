...
export default function Login() {
  ...
  const idRef = useAutoFocus(existingAccount);
  const pwRef = useAutoFocus(existingAccount && !!prefilledEmail);
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link to="/forgot-password" className="text-xs font-semibold text-ink/50 hover:text-coral-500">
                    Forgot?
                  </Link>
                </div>
                <div className="relative">
