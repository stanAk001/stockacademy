      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {loading ? (
          ...
          <div className="py-20 text-center">
            <Star className="mx-auto mb-3 text-ink/20" size={48} />
            <p className="font-display text-2xl font-bold mb-1">No stocks yet</p>
            <p className="text-ink/60 mb-5">Add your first stock to keep an eye on it.</p>
